...
if(isset($_POST['insert'])){
	...
	if($_SESSION['entity'] == 'Administrator'){
		...
		$logUsuario = new LogUsuario("","Create Administrator", "Name: " . $name . "; Last Name: " . $lastName . "; Email: " . $email . "; Password: " . $password . "; Phone: " . $phone . "; Mobile: " . $mobile . "; State: " . $state, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logUsuario -> insert();
	}
	$processed=true;
}
