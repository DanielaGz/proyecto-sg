...
if(isset($_POST['update'])){
	...
	$logUsuario = new LogUsuario("","Edit Profile Usuario", "Name: " . $name . "; Last Name: " . $lastName . "; Email: " . $email . "; Phone: " . $phone . "; Mobile: " . $mobile, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
	$logUsuario -> insert();
	$processed=true;
}
?>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Edit Profile Usuario</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
