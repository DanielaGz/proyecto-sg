			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=nombre&dir=asc'>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=nombre&dir=desc'>
						...
						<?php if($order=="detalle" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=detalle&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' data-placement='right' data-original-title='Sort Ascending' ></span></a>
						<?php } ?>
						<?php if($order=="detalle" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=detalle&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' data-placement='right' data-original-title='Sort Descending' ></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="config" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=config&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' data-placement='right' data-original-title='Sort Ascending' ></span></a>
						<?php } ?>
						<?php if($order=="config" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=config&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' data-placement='right' data-original-title='Sort Descending' ></span></a>
						<?php } ?>
						</th>
						<th nowrap>Fila 
						<?php if($order=="fila" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=fila&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' data-placement='right' data-original-title='Sort Ascending' ></span></a>
						<?php } ?>
						<?php if($order=="fila" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=fila&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' data-placement='right' data-original-title='Sort Descending' ></span></a>
						<?php } ?>
						</th>
						<th nowrap>Posicion 
						<?php if($order=="posicion" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=posicion&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' data-placement='right' data-original-title='Sort Ascending' ></span></a>
						<?php } ?>
						<?php if($order=="posicion" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=posicion&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' data-placement='right' data-original-title='Sort Descending' ></span></a>
						<?php } ?>
						</th>
						<th nowrap>Tamaño 
						<?php if($order=="tam" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=tam&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' data-placement='right' data-original-title='Sort Ascending' ></span></a>
						<?php } ?>
						<?php if($order=="tam" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/grafica/selectAllGrafica.php") ?>&order=tam&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' data-placement='right' data-original-title='Sort Descending' ></span></a>
						<?php } ?>
						</th>
						<th>Tablero</th>
					...
					$grafica = new Grafica();
					if($order != "" && $dir != "") {
						$graficas = $grafica -> selectAllOrder($order, $dir);
					} else {
						$graficas = $grafica -> selectAll();
					}
					$counter = 1;
