			...
			<table class="table table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' data-placement='right' data-original-title='Orden ascendente' href='index.php?pid=<?php echo base64_encode("ui/estrategia/selectAllEstrategiaByResultadoAprendizaje.php") ?>&idResultadoAprendizaje=<?php echo $_GET['idResultadoAprendizaje'] ?>&order=nombre&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="nombre" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' data-placement='right' data-original-title='Orden descendente' href='index.php?pid=<?php echo base64_encode("ui/estrategia/selectAllEstrategiaByResultadoAprendizaje.php") ?>&idResultadoAprendizaje=<?php echo $_GET['idResultadoAprendizaje'] ?>&order=nombre&dir=desc'>
						...
						<?php if($order=="detalle" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' data-placement='right' data-original-title='Orden ascendente' href='index.php?pid=<?php echo base64_encode("ui/estrategia/selectAllEstrategiaByResultadoAprendizaje.php") ?>&idResultadoAprendizaje=<?php echo $_GET['idResultadoAprendizaje'] ?>&order=detalle&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="detalle" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' data-placement='right' data-original-title='Orden descendente' href='index.php?pid=<?php echo base64_encode("ui/estrategia/selectAllEstrategiaByResultadoAprendizaje.php") ?>&idResultadoAprendizaje=<?php echo $_GET['idResultadoAprendizaje'] ?>&order=detalle&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
					...
					foreach ($estrategias as $currentEstrategia) {
						...
						if($_SESSION['entity'] == 'Administrator') {
							echo "<a href='index.php?pid=" . base64_encode("ui/estrategia/selectAllEstrategiaByResultadoAprendizaje.php") . "&idResultadoAprendizaje=" . $_GET['idResultadoAprendizaje'] . "&idEstrategia=" . $currentEstrategia -> getIdEstrategia() . "&action=delete' onclick='return confirm(\"Está seguro de eliminar el registro? " . $currentEstrategia -> getNombre() . "\")'> <span class='fas fa-backspace' data-toggle='tooltip' data-placement='left' data-original-title='Eliminar Estrategia' ></span></a> ";
						}
						if($_SESSION['entity'] == 'Administrator') {
