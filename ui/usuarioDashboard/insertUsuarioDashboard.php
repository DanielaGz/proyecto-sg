...
if(isset($_POST['insert'])){
	$newUsuarioDashboard = new UsuarioDashboard("", $usuario, $dashboard);
	$newUsuarioDashboard -> insert();
	...
	if($_SESSION['entity'] == 'Administrator'){
		$logAdministrator = new LogAdministrator("","Create Usuario Dashboard", "Usuario: " . $nameUsuario . ";; Dashboard: " . $nameDashboard , date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logAdministrator -> insert();
	}
	else if($_SESSION['entity'] == 'Usuario'){
		$logUsuario = new LogUsuario("","Create Usuario Dashboard", "Usuario: " . $nameUsuario . ";; Dashboard: " . $nameDashboard , date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logUsuario -> insert();
	}
	$processed=true;
}
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Create Usuario Dashboard</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/usuarioDashboard/insertUsuarioDashboard.php") ?>" class="bootstrap-form needs-validation"   >
						...
						<button type="submit" class="btn btn-secondary" name="insert">Create</button>
					</form>
				</div>
			</div>
		</div>
