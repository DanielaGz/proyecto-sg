...
$categoriaRa = new CategoriaRa($_GET['idCategoriaRa']); 
$categoriaRa -> select();
$error = 0;
		...
		<?php if(isset($_GET['action']) && $_GET['action']=="delete"){ ?>
			...
			<table class="table table-hover">
				<thead>
					...
					<?php
					$resultadoAprendizaje = new ResultadoAprendizaje("", "", "", "", $_GET['idCategoriaRa']);
					if($order!="" && $dir!="") {
						$resultadoAprendizajes = $resultadoAprendizaje -> selectAllByCategoriaRaOrder($order, $dir);
					} else {
						$resultadoAprendizajes = $resultadoAprendizaje -> selectAllByCategoriaRa();
					}
					$counter = 1;
